...
const adminClassRoutes    = require('./routes/classes');
const adminSubjectRoutes  = require('./routes/subjects');
const adminYearRoutes     = require('./routes/academicYears');
...
app.use('/admin/academic-years', adminYearRoutes);
